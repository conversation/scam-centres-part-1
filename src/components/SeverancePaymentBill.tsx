    ...
    <section className='bill_wrapper relative w-full text-[10px] sm:text-sm lg:text-lg' ref={sectionRef}>
      ...
      <div className='not-prose max-md:w-image-width w-image-width-md absolute left-1/2 top-[-0.6%] aspect-[1075/1263] -translate-x-1/2 border max-sm:left-[55%] sm:aspect-[103/121]'>
        ...
        <div className='absolute right-[13%] top-[46.3%] rotate-[6.1deg]'>
          ...
          <span className='scramble2 ml-6 bg-neutral-900 p-1 opacity-0 md:ml-10'>US$589.67</span>
        </div>
        <div className='absolute right-[14%] top-[57.1%] rotate-[6.8deg]'>
          ...
          <span className='scramble2 ml-6 bg-neutral-900 p-1 opacity-0 md:ml-10'>US$442.25</span>
        </div>
        <div className='absolute right-[15.6%] top-[67.7%] rotate-[7.3deg]'>
          ...
          <span className='scramble3 ml-6 bg-neutral-900 p-1 opacity-0 md:ml-10'>US$324.32</span>
        </div>
        <div className='absolute right-[16%] top-[70.5%] rotate-[7.6deg]'>
          ...
          <span className='scramble4 ml-6 bg-neutral-900 p-1 opacity-0 md:ml-10'>US$1,076.14</span>
        </div>
      </div>
    </section>
  )
